...
//    public MedicoEntity atualizarMedico(Long id, MedicoEntity medicoEntity) {
    public ResponseEntity<Void> atualizarMedico(Long id, MedicoEntity medicoEntity) {

            Assert.isNull(medicoEntity.getId(), "Não foi possível salvar este registro");
        ...
        if (!medicoEntity.getEmail().equals(medico.getEmail()) ||
                ...
                (medicoEntity.getEspecialidade() != null && !medicoEntity.getEspecialidade().equals(medico.getEspecialidade()))) {
